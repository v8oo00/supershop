...
class Ucpaas
{
    ...
    public function  __construct($options)
    {
        if (is_array($options) && !empty($options)) {
            $this->accountSid = isset($options['accountsid']) ? $options['accountsid'] : config('ucpaas.CPAAS_ACCOUNTSID');
            $this->token = isset($options['token']) ? $options['token'] : config('ucpaas.UCPAAS_TOKEN');
        } else {
