...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                {!! Form::open(['url' => 'admin/picture/update','method' => 'POST','class'=>'form-horizontal form-label-left','novalidate'=>'','enctype'=>"multipart/form-data"]) !!}
                      <p>
                          .
                      </p>
                      <span class="section">Please fill out the form correctly</span>

                          <input id="id" class="form-control col-md-7 col-xs-12" name="id" value='{{$picture->id}}' required="required" type="hidden">

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="route">Route <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="route" class="form-control col-md-7 col-xs-12" name="route" value="{{$picture->route}}" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="input-file-now" class="dropify" name="image" data-default-file="{{$picture->image}}"/>
