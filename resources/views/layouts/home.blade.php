...
<link href="/homes/css/menu.css" rel="stylesheet" type="text/css" media="all" /> <!-- menu style -->
<link href="/homes/css/ken-burns.css" rel="stylesheet" type="text/css" media="all" /> <!-- banner slider -->
<link href="/homes/css/animate.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="/homes/css/owl.carousel.css" rel="stylesheet" type="text/css" media="all"> <!-- carousel slider -->
...
<body>
	...
	<script src="/homes/js/main.js"></script> <!-- Resource jQuery -->
	<!-- //menu js aim -->
